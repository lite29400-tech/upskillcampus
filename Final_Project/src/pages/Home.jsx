    ...
    return (
        <React.Fragment>
            ...
            <div className=' '>
                        ...
                        <Course_Slider Courses={CatalogPageData?.mostSellingCourses?.length ? CatalogPageData?.mostSellingCourses : [
                            {
                                ...
                                instructor: { firstName: "Chris", lastName: "Evans" },
                            ...
                            },
                            {
                                ...
                                instructor: { firstName: "Mike", lastName: "Ross" },
                            ...
                            },
                            {
                                ...
                                instructor: { firstName: "Rachel", lastName: "Green" },
                                ratingAndReviews: [{ rating: 4.4 }],
                            }
                        ]} />
                    </div>
                ...
                {/*Section 2  */}
                <div className='bg-pure-greys-5 dark:bg-richblack-900 text-richblack-700 dark:text-richblack-5 '>
                ...
                {/*Section 3 */}
                <div className='mt-14 w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-white dark:bg-richblack-900 text-richblack-900 dark:text-white transition-colors duration-200'>
                    <InstructorSection />
